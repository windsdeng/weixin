...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action=alipayapi.php method=get >
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>卖家支付宝帐户：</dt>
                  <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDseller_email" value="" />
                        <span></span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" value="" />
                        <span></span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDtotal_fee" value="" />
                        <span></span>
                    </dd>
					<dt></dt>
                    <dd>
