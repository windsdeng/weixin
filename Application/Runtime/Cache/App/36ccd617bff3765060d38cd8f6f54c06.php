...
<body class="sanckbg mode_webapp">
	<div class="div_header">
			...
			<span class="header_right">
				...
				<div><span>合伙人：<?php if($users["member"] == 1): ?>是<?php else: ?>否(<a style='color:red' href='./index.php?g=App&m=Index&a=index'>点击购买成为合伙人</a>)<?php endif; ?></span></div>
				<div><span>关注时间：<?php echo date('Y-m-d',$wx_info['subscribe_time']); ?></span></div>
			</span>
		</div>
			<center><div><span style='color:red'>我为<?php echo ($message_name); ?>代言！</span></div></center>
		</span>
	</div>
